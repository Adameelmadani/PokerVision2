...
class SeatWidget(QFrame):
    ...
    def _setup_ui(self):
        ...
        seat_label.setFont(QFont("Segoe UI", 14, QFont.Weight.Bold))
        seat_label.setStyleSheet("color: #00d9ff;")
        ...
        self.name_label.setStyleSheet("color: #b0b0b0;")
        ...
        self.avatar_label.setFont(QFont("Segoe UI Emoji", 36))
...
class SetupScreen(QWidget):
    ...
    def _setup_ui(self):
        ...
        # Table image in center
        table_label = QLabel("🎴")
        table_label.setFont(QFont("Segoe UI Emoji", 48))
        table_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        seats_layout.addWidget(table_label, 1, 1, 1, 2)
        ...
        chips_label.setStyleSheet("color: #00c851;")
        ...
        sb_label.setStyleSheet("color: #3498db;")
        ...
        bb_label.setStyleSheet("color: #e74c3c;")
        ...
        self.start_btn.setFont(QFont("Segoe UI", 20, QFont.Weight.Bold))
    ...
    def _on_start(self):
        ...
        # Validate
        if len(players) < 2:
            self.error_label.setText("⚠️ Need at least 2 players to start!")
